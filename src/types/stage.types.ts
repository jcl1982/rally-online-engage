...
export const stageSchema = z.object({
  ...
  difficulty_level: z.enum(["easy", "medium", "hard"], { required_error: "La difficulté est requise" }),
  route_type: z.enum(["asphalt", "gravel", "mixed"], { required_error: "Le type de route est requis" }),
